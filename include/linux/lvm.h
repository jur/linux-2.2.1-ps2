 ...
 * May-July 1998
 * January-March,July,September,October 1999
 *
...
#define	_LVM_H_VERSION	"LVM 0.8 (17/09/1999)"
...
#ifndef	LVM_BLOCK_MAJOR
#define	LVM_BLOCK_MAJOR	58
#endif
#ifndef	LVM_CHAR_MAJOR
#define	LVM_CHAR_MAJOR	109
#endif

#if !defined ( LVM_BLOCK_MAJOR) || !defined ( LVM_CHAR_MAJOR)
...
#define	LVM_SNAPSHOT_MIN_CHUNK	1	/* 1k */
#define	LVM_SNAPSHOT_DEF_CHUNK	64
#define	LVM_SNAPSHOT_MAX_CHUNK	8192
...
typedef struct {
	...
	uint32_t lv_read_ahead;
	/* delta to version 1 starts here */
	int lv_snapshot_minor;
	lv_v2_exception_t *lv_exception;
} lv_v2_t;
